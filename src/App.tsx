    ...
    <div className="w-screen h-screen bg-gray-900 flex flex-col items-center justify-center text-gray-100">
      ...
      <form className="flex flex-col items-stretch w-full max-w-sm mt-10 gap-4">
        <label htmlFor="email" className="flex flex-col gap-3">
          <Text className="font-semibold">Endreço de E-mail</Text>
          <TextInput.Root>
        ...
        <label htmlFor="remember" className="flex items-center gap-2">
          <Checkbox id="remember"></Checkbox> <Text size="sm" className="text-gray-200 font-semibold">Lembrar de mim por 30 dias</Text>
        </label>
